    ...
    <div className="wm-page-shell min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/">
            <motion.h1
              className="wm-page-title text-4xl young-serif-regular font-bold mb-2"
              animate={{
                textShadow: [
          ...
          <p className="wm-page-subtitle">Create your account and start tracking</p>
        </div>

        <Card className="wm-card-strong rounded-2xl p-8 shadow-[0_0_40px_rgba(99,102,241,0.2)]">
          <h2 className="wm-text-primary text-2xl young-serif-regular text-center font-bold mb-6">Sign Up</h2>
          ...
          <form onSubmit={handleSignUpSubmit} className="space-y-4">
            ...
            <div className="space-y-1 text-sm">
              {passwordRules.map((rule) => (
                <p key={rule.label} className={rule.isValid ? 'text-green-500' : 'wm-text-muted'}>
          ...
          <div className="mt-6 text-center">
            <p className="wm-text-secondary">
              ...
              <Link to="/login" className="wm-link font-semibold">
                Login
              </Link>
            </p>
          </div>
