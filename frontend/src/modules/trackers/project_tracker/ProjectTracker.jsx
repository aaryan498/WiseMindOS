          ...
          <Card className="bg-white/5 backdrop-blur-xl border border-white/10">
            ...
            {projectTasks.length > 0 ? (
              ...
              <EmptyState
                ...
                description="Add the first task to turn this project into a clear sequence of actions."
                actionLabel="Add Task"
                onAction={() => setShowAddTask(true)}
                accent="emerald"
                testId="empty-selected-project-tasks"
              />
            )}
          </Card>
        </div>
        ...
        {projects.length > 0 ? (
          ...
          <Card className="bg-white/5 backdrop-blur-xl border border-white/10 text-center">
            <EmptyState
              ...
              description="Create a project to organize related tasks around a goal, milestone, or focused work stream."
